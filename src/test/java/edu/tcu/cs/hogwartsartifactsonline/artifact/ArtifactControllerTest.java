...
class ArtifactControllerTest {
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        saveArtifact.setImgUrl("ImageUrl");
        ...
        this.mockMvc.perform(post("/api/v1/artifacts").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.data.imgUrl").value(saveArtifact.getImgUrl()));
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        ArtifactDto artifactDto = new ArtifactDto(null, "Invisibility Cloak",
                "A new description.",
                "ImageUrl",
                null);
    ...
    @Test
    void testDeletedArtifactSuccess() throws Exception {
        //given
    ...
    @Test
    void testDeletedArtifactErrorWithNonExistentId() throws Exception {
        //given
