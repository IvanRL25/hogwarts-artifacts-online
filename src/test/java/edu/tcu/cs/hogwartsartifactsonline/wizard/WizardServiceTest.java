...
class WizardServiceTest {
    ...
    void testFindAllSuccess(){
        ...
        //when
        List<Wizard> actualWizards = this.wizardServic.findAll();
        //then
    ...
    void testFindByIdSuccess(){
        ...
        Wizard returnedWizard = this.wizardServic.findById(1);
    ...
    void testSaveSuccess(){
        ...
        Wizard returnedWizard = this.wizardServic.save(newWizard);
    ...
    void testUpdateSuccess(){
        ...
        Wizard updatedWizard = this.wizardServic.update(1, update);
